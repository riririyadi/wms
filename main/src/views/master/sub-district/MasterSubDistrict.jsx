...
export default class MasterSubDistrict extends React.Component {
    ...
    _buildGrid() {
        return (
            <AzecGrid ref={this.refGrid}
                header={{
                    columnWidth: [40, 180, -1, -1],
                    columns: ["No", "Sub District Code", "Sub District Name", "District Name"]
                }}
                renderRow={
                    (item, index) => {
                        return [(index + 1), item.code, item.name, item.district];
                    }
                }
                onRowSelected={(index) => {
