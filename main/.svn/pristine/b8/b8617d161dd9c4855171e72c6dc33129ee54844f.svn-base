...
export default class MovementStock extends React.Component {
    ...
    _buildReportView() {
        const iframe = '<iframe src="http://192.168.100.51:3001/assets/rpt-movement.pdf" width="100%" height="400px"></iframe>';
        const data = {
            __html : iframe
        }
