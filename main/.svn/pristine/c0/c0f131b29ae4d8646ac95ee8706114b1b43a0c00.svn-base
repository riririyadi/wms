...
export default class ReportAllStock extends React.Component {
    ...
    _buildReportView() {
        const iframe = '<iframe src="http://192.168.100.51:3001/assets/rpt-all-stock.pdf" width="100%" height="400px"></iframe>';
        const data = {
            __html : iframe
        }
